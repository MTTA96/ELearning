...
public class KhoaHocDaHoanTat {
    ...
    public KhoaHocDaHoanTat(String nguoiDang, int soBuoiHoc, int soLuongHocVien, String ngayDang, String gioDang, float thoiLuongBuoiHoc, float hocPhi, String thongTinKhac, ArrayList<String> mon, ArrayList<String> linhVuc, ArrayList<String> lop, com.eways.elearning.Data.DataModel.KhoaHoc.LichHoc lichHoc, com.eways.elearning.Data.DataModel.KhoaHoc.DiaDiem diaDiem, ArrayList<String> danhSachNhan) {
        NguoiDang = nguoiDang;
        SoBuoiHoc = soBuoiHoc;
