                ...
                .addOnCompleteListener(activity, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            mData.getReference().child("TaiKhoan").child(user.getUid()).setValue(new TaiKhoan(user.getUid(),user.getEmail(),taiKhoan.getHo(),taiKhoan.getTen(),"null",false, SupportKeysList.TAI_KHOAN_GMAIL,taiKhoan.getPassword(),"null","null","null","null","null","null","null","null","null",false));
